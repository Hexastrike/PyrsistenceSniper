...
def test_load_cache_returns_none_when_missing(tmp_path: Path) -> None:
    ...
    with patch(
        "pyrsistencesniper.resolution.lolbins._CACHE_FILE",
...
def test_load_cache_returns_frozenset(tmp_path: Path) -> None:
    ...
    with patch("pyrsistencesniper.resolution.lolbins._CACHE_FILE", cache):
        result = _load_cache()
...
def test_load_lolbin_names_prefers_cache() -> None:
    ...
    with patch(
        "pyrsistencesniper.resolution.lolbins._load_cache",
